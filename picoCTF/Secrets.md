...
## Solution
Visit `http://saturn.picoctf.net:50167/`, notice there is a `secret` directory
```html
...
```
Visit `http://saturn.picoctf.net:50167/secret`, notice there is a `hidden` directory
```html
...
```
Visit `http://saturn.picoctf.net:50167/secret/hidden/`, notice there is a `superhidden` directory
```html
...
```
Visit `http://saturn.picoctf.net:50167/secret/hidden/superhidden/` and find the flag
```html
